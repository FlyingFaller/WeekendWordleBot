...
class MinimalProgressBarApp(App[None]):
    """An app with a fully-featured, toggleable progress bar."""
    ...
    def on_key(self) -> None:
        ...
        if progress_bar.percentage is None:
            progress_bar.total = 100
            progress_bar.progress = 0
            # The clock reset is now handled automatically by the watch methods.
